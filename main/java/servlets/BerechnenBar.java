 ...
 */
@WebServlet("/BerechnenBar")
public class BerechnenBar extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)  throws ServletException, IOException {
	    ...
	    out.println("<form action = BerechnenBarBezahlt method=post>");
		...
		out.println("<input type=\"text\" name=\"gegeben\" placeholder=\"Gegeben\">");
