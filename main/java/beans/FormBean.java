...
public class FormBean {
  ...
  public int getAnzahlSteak() {
    return tische[tischNr - 1][7];
  }

  public void setAnzahlSteak(int anzahlSteak) {
    tische[tischNr - 1][7] = anzahlSteak;
  }

  public int getAnzahlWildeKartoffeln() {
    return tische[tischNr - 1][8];
  }

  public void setAnzahlWildeKartoffeln(int anzahlWildeKartoffeln) {
    tische[tischNr - 1][8] = anzahlWildeKartoffeln;
  }
